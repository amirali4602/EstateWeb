        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    permisionDelete = table.Column<bool>(type: "bit", nullable: true),
                    permisionEdit = table.Column<bool>(type: "bit", nullable: true),
                    whatsApp = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    instagram = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    telegram = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    minRange = table.Column<double>(type: "float", nullable: true),
                    maxRange = table.Column<double>(type: "float", nullable: true),
                    FeaturedMax = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowCustomerNumber = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "ام دی اف اتریشی" },
                    { 2, "ام دی اف ملامینه پاک چوب" },
                    { 3, "ام دی اف ملامینه پویا" },
                    { 4, "ایزوفام سینکرونایز" },
                    { 5, "ایزوفام ملامینه" },
                    { 6, "ایزوفام هایگلاس" },
                    { 7, "نئوپان ملامینه پویا" },
                    { 8, "هایگلاس AGE" },
                    { 9, "هایگلاس آلکی" },
                    { 10, "بدون دسته‌بندی" }
                });
